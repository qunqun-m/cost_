...
class Train_instance:
    ...
    def read_one_instrance_file(self,traing_instaces_path,item_num):
        # file_path=traing_instaces_path+'_{}'.format(sec_count_id)
        historys,labels=[],[]
        with open(traing_instaces_path) as f:
            for line in f:
    ...
    '''
    def read_all_instances_files(self,traing_instaces_path, item_num):
        his_maxtix=None
        labels=None
        part_his,part_labels=self.read_one_instrance_file(traing_instaces_path,item_num)
    ...
    def get_training_data(self,traing_instaces_path, item_num):
        history_matrix,positive_labels=self.read_all_instances_files(traing_instaces_path,item_num)
        '''
